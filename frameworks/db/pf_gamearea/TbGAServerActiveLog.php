...
class TbGAServerActiveLog {
	...
	public static function insertSqlHeader(/*array*/ $fields=NULL)
	{
		...
		if(!empty($fields)){
			...
			$result[0]="INSERT INTO `GA_ServerActiveLog` (`ga_ServerActiveLogIndex`,`ga_GameID`,`ga_AreaID`,`ga_ServerID`,`pt_AccountKey`,`pt_OpenUID`,`ga_ServerActiveInfo`,`ga_ActiveInfoUpdateTime`,`ga_ActiveCode`,`ga_LastLoginTime`,`ga_ActiveTime`,`ga_Activeip`,`ga_Activestate`,`ga_RoleId`,`ga_RoleName`) VALUES ";
			$result[1] = array('ga_ServerActiveLogIndex'=>1,'ga_GameID'=>1,'ga_AreaID'=>1,'ga_ServerID'=>1,'pt_AccountKey'=>1,'pt_OpenUID'=>1,'ga_ServerActiveInfo'=>1,'ga_ActiveInfoUpdateTime'=>1,'ga_ActiveCode'=>1,'ga_LastLoginTime'=>1,'ga_ActiveTime'=>1,'ga_Activeip'=>1,'ga_Activestate'=>1,'ga_RoleId'=>1,'ga_RoleName'=>1);
		}				
		return $result;
	}
