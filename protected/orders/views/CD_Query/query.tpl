    ...
    <div style="margin:20px 0;">
     ...
     <div style="margin:20px 0;">
    	...
    	<select id="select_channel" class="easyui-combobox" name="state" style="width:150px;">
    		<option selected value="请选择渠道">请选择渠道</option>
    	</select>
     ...
     <div style="margin:20px 0;">
     	<span>訂單類型：</span>
    	<select id="select_channel" class="easyui-combobox" name="state" style="width:150px;">
    		<option selected value="訂單類型">訂單類型</option>
    	</select>
    	
    	<span>&nbsp;&nbsp;訂單狀態：</span>
    	<select id="select_game" class="easyui-combobox" name="state" style="width:150px;">
    		<option selected value="訂單狀態">訂單狀態</option>
    	</select>
    	
    	<span>&nbsp;&nbsp;收款狀態：</span>
    	<select id="select_money_source" class="easyui-combobox" name="state" style="width:150px;">
    		<option selected value="收款狀態">收款狀態</option>
    	</select>
     </div>
     <div style="margin:20px 0;">
     	<span>平臺單號：</span>
     ...
     <div style="margin:20px 0;">
     	<span>儲值賬號：</span>
     	<input id="order_account" class="easyui-textbox" style="width:150px;height:30px">
     	<span>&nbsp;&nbsp;儲值金額：</span>
     ...
     <div style="margin:20px 0;">
	    ...
	    <a href="javascript:void(0)" class="easyui-linkbutton" style="width:100px;height:30px" onclick="">退款訂單導入</a>
	    <a href="javascript:void(0)" class="easyui-linkbutton" style="width:100px;height:30px" onclick="">人工補單</a>
	</div>
